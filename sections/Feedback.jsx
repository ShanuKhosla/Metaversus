...
const Feedback = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div
      ...
      className="flex-0.5 lg:max-w-[370px] flex justify-end flex-col gradient-05 sm: p-8
      p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative"
      >
    ...
    <motion.div
      ...
      <motion.div
        ...
        <motion.img
          src="/stamp.png"
          alt="stamp"
          className="sm:w-[155px] w-[130px] sm:h-[155px]
